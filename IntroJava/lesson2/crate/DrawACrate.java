...
public class DrawACrate
{
    public static void main(String[] args)
    {
        ...
        Line topleft = new Line(20,30,50,10);
        Line topright = new Line(120,30,150,10);
        Line topback = new Line(50,10,150,10);
        Line bottomright = new Line(120,70,150,50);
        Line backrightvert = new Line(150,10,150,50);
