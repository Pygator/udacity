...
public class Book
{
    ...
    */
    public String getSecondSentence()
    {
        ...
        // the second period
        int endOfFirstSentence = bookText.indexOf(".")+1;
        int endOfSecondSentence = bookText.indexOf(".",endOfFirstSentence)+1;
        return bookText.substring(endOfFirstSentence, endOfSecondSentence);
    }
