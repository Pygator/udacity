...
public class Book
{
    ...
    */
    public int occurrencesOf(String word)
    {
        ...
        int initialLength=bookText.length();
        int finalLength=bookText.replace(word,"").length();
        int diffLength=initialLength - finalLength;
        int wordCount = (int)(diffLength/lengthOfWord);
        return wordCount;
    }
    ...
    */
    public String getSecondSentence()
    {
        ...
        // the second period
        int beginOfSentence = bookText.indexOf(".") + 1;
        int endOfSentence = bookText.indexOf(".",beginOfSentence) + 1;
        return bookText.substring(beginOfSentence,endOfSentence);
    }
