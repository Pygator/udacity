...
public class Word
{
    ...
    */
    public String getPluralForm()
    {
        ...
        if (is(wordLength-1,"y"))
        {
            if ( isVowel(wordLength-2) )
            {
                return letters + "s";
            }
            else 
            {
                return letters.substring(0,wordLength-1)+"ies";
            }
            
        }
        
        if ( is(wordLength-1,"o") || is(wordLength-1,"s") ) {
            return letters + "es";
        }
        else if ( is(wordLength-1,"h") && 
                 ( is(wordLength-2,"s") || is(wordLength-2,"c") ) )
                 {
                     return letters + "es";
                 }
        else {
